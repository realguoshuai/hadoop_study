...
public class SolrClientHelper {
    ...
    private  SolrClient suggest_client;
    private  final String PROPERTIES_PATH = "solr.properties";
   ...
   public SolrClientHelper(){
    ...
    public  SolrClient getSuggestClient() {
        try {
    ...
    */
    public  HttpSolrClient getSolrClient()throws Exception {
    ...
    */
    public  CloudSolrClient getCloudSolrClient()throws Exception {
    ...
    private  void initProperties_alone() throws Exception {
    ...
    /*号牌智能提醒 初始化*/
    private  void initProperties_suggest() throws Exception {
     ...
     * @return
     */
    public    List<String> queryAllCollections(CloudSolrClient cloudSolrClient) {
    ...
    public  List<SolrQuery.SortClause> getSortClause(String sortStr) {
    ...
    private  HttpSolrClient createSimpleSolrClient() {
        try {
     ...
     * @throws Exception
     */
    private  CloudSolrClient createCloudSolrClient() throws Exception {
        //initProperties();
    ...
    public  void queryDocs(String queryCon) {
